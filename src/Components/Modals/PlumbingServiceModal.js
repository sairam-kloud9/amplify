import PlumbingDetailedModal from "./PlumbingDetailedModal";

const PlumbingServiceModal = () => {
  return (
    <div
      className="modal centered_Modal selection_modal pest_control_modal"
      id="plumbingServiceModal"
    >
            ...
            <div className="please_select">
              ...
              <div class="form-group-btn">
                <button
                  ...
                  data-toggle="modal"
                  data-target="#plumbingdetailedModal"
                >
                  Continue
                </button>
              </div>
      ...
      <PlumbingDetailedModal />
    </div>
  );
};

export default PlumbingServiceModal;
