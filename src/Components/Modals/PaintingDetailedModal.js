                      ...
                      <nav className="sservice_tabs_ul" id="service_scrollspy">
                        <ul className="nav">
                          <li className="nav-item">
                            <a className="nav-link active" href="#HomePainting">
                              Home Painting
                            </a>
                          </li>
                          <li className="nav-item">
                            <a className="nav-link" href="#WaterProofing">
                              Water Proofing
                            </a>
                          </li>
                        </ul>
                      ...
                      >
                        ...
                        <div className="one_service_div">
                          <div className="one_service_img">
                            <img
                              src="images/painting-consultation.avif"
                              alt="img"
                            />
                          </div>
                          ...
                          <ul className="one_service_listing">
                            ...
                            <li>
                              Basis your inputs, the consultant will share
                              customized quotation(s)
                            </li>
                            <li>
                              <a
                      ...
                      >
                        ...
                        <div className="one_service_div">
                          ...
                          <div className="one_service_info">
                            <div className="d-flex align-items-center service_flex">
                              <div className="one_service_det">
                                <h5>Water Proofing Consultation</h5>
                              </div>
                              <div className="one_service_btn">
                                <button
                                  type="button"
                          ...
                          <ul className="one_service_listing">
                            <li>
                              Protection against seepage that results into
                              fungus, mould, and peeling paint
                            </li>
                            <li>
                              Basis your inputs, the consultant will share
                              customized quotation(s)
...
export default PaintingDetailedModal;
