                ...
                <div className="row">
                    ...
                    <div className="single_service_tabs">
                      <nav className="sservice_tabs_ul" id="service_scrollspy">
                        <ul className="nav">
                          ...
                          <li className="nav-item">
                            <a className="nav-link" href="#basinSink">
                              Basin & sink
                            </a>
                          </li>
                        </ul>
                  ...
                  <div className="col-md-5">
                    <div className="service_tab_scroll">
                      ...
                      >
                        ...
                        <div className="one_service_div">
                          <div className="one_service_img">
                            <img src="images/tap-repair.avif" alt="img" />
                          </div>
                          ...
                          <ul className="one_service_listing">
                            <li>
                              Repair of one broken or leaking single knob/ inlet
                              tap
                            </li>
                            <li>
                              Applicable for kitchen sink, wash basin & bathroom
                            </li>
                            <li>
                              <a
                      ...
                      <div id="basinSink" className="single_service_tab_scroll">
                        <h2>Basin & sink</h2>
                        <div className="one_service_div">
                          <div className="one_service_img">
                            <img
                              src="images/pipe-leakage-repair.avif"
                              alt="img"
                            />
                          </div>
                          <div className="one_service_info">
...
export default PlumbingDetailedModal;
